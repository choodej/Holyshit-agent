...
3. ถ้าข้อมูลไม่ครบ ให้ถามเชิงรุกทีละชุดสั้นๆ ไม่เกิน 5 คำถาม
4. ถ้าเป็น decision point ใหญ่ ให้ใช้ RULES.md §10:
   เสนอ 4 ทางเลือก A/B/C/D พร้อม recommended และเหตุผล/tradeoff
5. ห้ามเดาเป้าหมายแทนผม และห้ามเริ่มสร้าง dashboard/database/queue/AI brain ก่อน proof
...
2. เสนอ smallest useful slice
3. เสนอชื่อ organ/module ที่จะสร้าง
4. ถ้าไม่มี decision point ค้าง ให้ลงมือสร้างแบบ OOP/Hexagonal ตาม organ-kit
5. ก่อนบอกว่าสำเร็จ ให้รัน:
   cd sandbox
   python tools/check.py
6. รายงานผลตามจริง พร้อมบอกว่าขาดอะไรถ้ายังไม่ implementation-done
```
